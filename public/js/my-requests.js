...
$(".button.viewdetails").click(function () { 
    ...
    $.ajax({ 
        ...
        success : function(form){
            if (form){
                $('.ui.modal.viewdetails').modal('show');
                ...
                if (form.grantName == "[FD1] Incentive for Publication in Pre-Selected High Impact Journal"){
                    ...
                    doc.text(113,238, moment(form.dateOfConference).format('LL') + "")
                    doc.text(113,726, moment(form.dateOfConference).format('LL') + "")
                    ...
                    doc.text(113,213, moment(form.dateOfConference).format('LL'))
                    doc.text(113,700, moment(form.dateOfConference).format('LL'))
                    ...
                    doc.text(118,195, moment(form.dateOfConference).format('LL'))
                    doc.text(118,678, moment(form.dateOfConference).format('LL'))
                    ...
                    doc.text(122,167, moment(form.dateOfConference).format('LL'))
                    doc.text(122,615, moment(form.dateOfConference).format('LL'))
